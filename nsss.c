  ...
  */
   ...
   ierr = MakeSphere(&eos, &star, e_center,&eosDM, &starDM, e_centerDM); 
      /*if(star.r_eDM==-1){
        ...
        printf("e_c  e_cDM  MassTot    MassBM    MassDM   RadiusBM  RadiusDM  Rratio_Sch_BM RratioBM RratioDM  Omega OmegaDM  Omega_K \n" );
while(ratio_r>=0.7){
  ...
  /*call = Surface(&eos,&star,&poten[0],&poten[1],&poten[2],&poten[3]);
    for(i=1; i<= MDIV; i++){
      ...
      printf("%g %g %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.3f %.3f %.5f\n",
        star.e_center, star.e_centerDM, star.Mass/MSUN+star.MassDM/MSUN, star.Mass/MSUN, star.MassDM/MSUN, star.R_e*1e-5, star.R_eDM*1e-5, star.Ratio_sch,ratio_r, star.r_ratioDM, star.Omega/(2.0*PI),star.OmegaDM/(2.0*PI), star.Omega_K/(2.0*PI));
           
      fprintf(fpointer,"%g %g %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.5f %.3f %.3f %.5f\n",
        star.e_center, star.e_centerDM, star.Mass/MSUN+star.MassDM/MSUN, star.Mass/MSUN, star.MassDM/MSUN, star.R_e*1e-5, star.R_eDM*1e-5, star.Ratio_sch,ratio_r, star.r_ratioDM, star.Omega/(2.0*PI),star.OmegaDM/(2.0*PI), star.Omega_K/(2.0*PI));
