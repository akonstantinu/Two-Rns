...
typedef struct{               
  char eos_fileDM[80];          /*The name of the EOS file as stored on the computer*/
  char eos_typeDM[10];          /*Tabulated, Polytropic, or Quark*/
  char data_dirDM[80];          /*The location the output legendre files are sent to*/
...
typedef struct {
  ...
  double MassDM;                 /*In Solar Mass Units*/
  ...
  double Ratio_sch;                  /*Schwarzschild radial coordinate (unitless) */
  double R_eDM;                  /*Schwarzschild radial coordinate (unitless) */
  ...
  double ang_momDM;              /*Angular momentum of the star, in units of g*cm^2/s*/
  double **energy, **pressure, **enthalpy, **velocity_sq;    /*s by mu grid of Energy Density, Pressure, Enthalpy */
  double **energyDM, **pressureDM, **enthalpyDM, **velocity_sqDM;    /*s by mu grid of Energy Density, Pressure, Enthalpy */
